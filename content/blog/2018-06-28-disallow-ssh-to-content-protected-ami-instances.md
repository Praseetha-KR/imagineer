...
slug: disallow-ssh-to-content-protected-ami-instances
...
<div class="m-1-top">
    <div class="code-snippet">
        <div class="chroma-filename">/opt/customssh/override_ssh_key</div>
...
<div class="m-1-top">
    <div class="code-snippet">
        <div class="chroma-filename">/etc/systemd/system/customssh.service</div>
        <div class="chroma-linenos">
